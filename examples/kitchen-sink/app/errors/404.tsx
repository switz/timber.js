    ...
    <div data-testid="segment-not-found-page" className="max-w-lg space-y-4">
      ...
      <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
        <p className="text-sm text-amber-800">
          This is{' '}
          <code className="rounded bg-amber-100 px-1 py-0.5 text-xs font-mono">errors/404.tsx</code>{' '}
          — a segment-level status-code file. It takes priority over the root 404.tsx for routes
          under <code className="rounded bg-amber-100 px-1 py-0.5 text-xs font-mono">/errors/</code>
          .
        </p>
      </div>
      {dangerouslyPassData != null && (
        <div className="rounded-lg border border-stone-200 bg-white p-4">
          ...
          <pre
            data-testid="segment-not-found-data"
